...
Usage:
    python tools/data_collector.py --source images/ --output dataset/
"""
...
class ChessPieceDataCollector:
    ...
    def __init__(self, output_dir: Path):
        ...
        # Piece class mapping (same as BoardState)
        self.piece_classes = {
