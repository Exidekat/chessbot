...
def main():
    ...
    # Temporarily modify to control preprocessing
    # (In a real scenario, we'd pass this as a parameter through snapshot)
    try:
        detected_fen = detector.snapshot(args.image, output_format='fen', debug=False)
